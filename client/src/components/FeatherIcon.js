...
const FeatherIcon = ({ name, size = 24, color = '#484848' }) => {
  const icons = {
    folder: (
    ...
    building: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <polyline points="12 3 20 7.5 20 19.5 12 24 4 19.5 4 7.5 12 3"></polyline>
        <polyline points="12 12 20 7.5"></polyline>
        <polyline points="12 24 12 12"></polyline>
    ...
    handshake: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 15v2a2 2 0 0 1-2 2h-5"></path>
        <path d="M3 11v-2a2 2 0 0 1 2-2h5"></path>
        <path d="M8 12l4 4 8-8"></path>
      </svg>
    ),
    mic: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
